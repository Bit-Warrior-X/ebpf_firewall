    ...
    while (fgets(line, sizeof(line), fp)) {
        ...
        if (sscanf(line, "%127[^=]= %d", key, &int_value) == 2) {
            ...
            // SYN config
                ...
                global_fw_config.g_syn_config.syn_threshold = int_value;
            } else if (strcmp(key, "syn_burst_pkt") == 0) {
                global_fw_config.g_syn_config.burst_pkt_threshold = int_value;
            } else if (strcmp(key, "syn_burst_count_per_sec") == 0) {
                global_fw_config.g_syn_config.burst_count_threshold = int_value;
            } else if (strcmp(key, "challenge_timeout") == 0) {
                global_fw_config.g_syn_config.challenge_timeout = int_value * ONE_SECOND_NS;
                ...
                global_fw_config.g_syn_config.syn_fixed_check_duration = int_value * ONE_SECOND_NS;
            } 
            //ACK config
            else if (strcmp(key, "ack_threshold") == 0) {
                global_fw_config.g_ack_config.ack_threshold = int_value;
            } else if (strcmp(key, "ack_burst_pkt") == 0) {
                global_fw_config.g_ack_config.burst_pkt_threshold = int_value;
            } else if (strcmp(key, "ack_burst_count_per_sec") == 0) {
                global_fw_config.g_ack_config.burst_count_threshold = int_value;
                ...
                global_fw_config.g_ack_config.ack_fixed_check_duration = int_value * ONE_SECOND_NS;
            } 
            //RST config
            else if (strcmp(key, "rst_threshold") == 0) {
                global_fw_config.g_rst_config.rst_threshold = int_value;
            } else if (strcmp(key, "rst_burst_pkt") == 0) {
                global_fw_config.g_rst_config.burst_pkt_threshold = int_value;
            } else if (strcmp(key, "rst_burst_count_per_sec") == 0) {
                global_fw_config.g_rst_config.burst_count_threshold = int_value;
                ...
                global_fw_config.g_rst_config.rst_fixed_check_duration = int_value * ONE_SECOND_NS;
            } 
            //ICMP config
            else if (strcmp(key, "icmp_threshold") == 0) {
                global_fw_config.g_icmp_config.icmp_threshold = int_value;
            } else if (strcmp(key, "icmp_burst_pkt") == 0) {
                global_fw_config.g_icmp_config.burst_pkt_threshold = int_value;
            } else if (strcmp(key, "icmp_burst_count_per_sec") == 0) {
                global_fw_config.g_icmp_config.burst_count_threshold = int_value;
                ...
                global_fw_config.g_icmp_config.icmp_fixed_check_duration = int_value * ONE_SECOND_NS;
            } 
            //UDP config
            else if (strcmp(key, "udp_threshold") == 0) {
                global_fw_config.g_udp_config.udp_threshold = int_value;
            } else if (strcmp(key, "udp_burst_pkt") == 0) {
                global_fw_config.g_udp_config.burst_pkt_threshold = int_value;
            } else if (strcmp(key, "udp_burst_count_per_sec") == 0) {
                global_fw_config.g_udp_config.burst_count_threshold = int_value;
                ...
                global_fw_config.g_udp_config.udp_fixed_check_duration = int_value * ONE_SECOND_NS;
            } 
            //GRE config
            else if (strcmp(key, "gre_threshold") == 0) {
                global_fw_config.g_gre_config.gre_threshold = int_value;
            } else if (strcmp(key, "gre_burst_pkt") == 0) {
                global_fw_config.g_gre_config.burst_pkt_threshold = int_value;
            } else if (strcmp(key, "gre_burst_count_per_sec") == 0) {
                global_fw_config.g_gre_config.burst_count_threshold = int_value;
                ...
                global_fw_config.g_gre_config.gre_fixed_check_duration = int_value * ONE_SECOND_NS;
            }
            else {
